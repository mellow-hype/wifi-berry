...
# --------------------------------------------------------------------------- #
# Core Functions: these are used by both Automagic and Wizard mode for
# configuration and some other small tasks.
# --------------------------------------------------------------------------- #
...
# --------------------------------------------------------------------------- #
# Auxiliary functions for handling input data
# --------------------------------------------------------------------------- #
...
# --------------------------------------------------------------------------- #
# Configuration functions that will handle modifying the config files with the
...
def wizard_ipconf(settings_d=ip_conf_default_d):
...
def wizard_dnsmasq(iface_in, upstr, dhcp_set):
...
def wizard_hostapd(iface_in, ssid, chan):
